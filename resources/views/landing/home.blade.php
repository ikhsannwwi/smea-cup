    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-5 ml-auto">
          <h1 class="text-white">Smea Cup Event</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta, molestias repudiandae pariatur.</p>
          <div id="date-countdown"></div>
          <p>
            <a href="#" class="btn btn-primary py-3 px-4 mr-3">Details</a>
        ...
        <div class="d-flex team-vs">
          ...
          <div class="team-1 w-50">
            <div class="team-details w-100 text-center">
              <img src="{{('soccer-master/images/logo_1.png')}}" alt="Image" class="img-fluid">
          ...
          <div class="team-2 w-50">
            <div class="team-details w-100 text-center">
              <img src="{{('soccer-master/images/logo_2.png')}}" alt="Image" class="img-fluid">
      ...
      <div class="row no-gutters">
        <div class="col-md-4">
          <div class="post-entry">
            <a href="#">
              <img src="{{('soccer-master/images/img_1.jpg')}}" alt="Image" class="img-fluid">
            </a>
            <div class="caption">
              <div class="caption-inner">
                ...
                <div class="author d-flex align-items-center">
                  <div class="img mb-2 mr-3">
                    <img src="{{('soccer-master/images')}}/person_1.jpg" alt="">
                  </div>
                  <div class="text">
        ...
        <div class="col-md-4">
          <div class="post-entry">
            <a href="#">
              <img src="{{('soccer-master/images/img_3.jpg')}}" alt="Image" class="img-fluid">
            </a>
            <div class="caption">
              <div class="caption-inner">
        ...
        <div class="col-md-4">
          <div class="post-entry">
            <a href="#">
              <img src="{{('soccer-master/images/img_2.jpg')}}" alt="Image" class="img-fluid">
            </a>
            <div class="caption">
              <div class="caption-inner">
              ...
              <div class="widget-vs">
                <div class="d-flex align-items-center justify-content-around justify-content-between w-100">
                  <div class="team-1 text-center">
                    <img src="{{('soccer-master/images/logo_1.png')}}" alt="Image">
                  ...
                  <div class="team-2 text-center">
                    <img src="{{('soccer-master/images/logo_2.png')}}" alt="Image">
                    <h3>Soccer</h3>
                  </div>
                </div>
              </div>
